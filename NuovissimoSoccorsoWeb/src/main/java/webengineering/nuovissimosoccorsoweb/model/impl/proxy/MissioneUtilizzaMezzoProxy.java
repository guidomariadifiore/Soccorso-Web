...
import webengineering.nuovissimosoccorsoweb.model.impl.MissioneUtilizzaMezzoImpl;

public class MissioneUtilizzaMezzoProxy extends MissioneUtilizzaMezzoImpl implements DataItemProxy {
    ...
    public void setTargaMezzo(String targaMezzo) {
        super.setTargaMezzo(targaMezzo);
        this.modified = true;
    }
